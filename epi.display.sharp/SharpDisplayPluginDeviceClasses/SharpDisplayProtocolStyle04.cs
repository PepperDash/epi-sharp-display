...
{
    public class SharpDisplayProtocolStyle04 : SharpDisplayBase, IHasPower, IHasPowerToggle, IHasInput
    {
        ...
        public SharpDisplayProtocolStyle04(SharpDisplayPluginDevice device, SharpDisplayPluginConfigObject config)
            : base(device, config)
        {
        ...
        public override void ParseFeedback(string feedback)
        {
            ...
            {          
                ...
                else if (Command.ToString().Contains("INPS"))
                {
        ...
        {
            DisplayDevice.SendLine(string.Format("INPS   {0}", input));
        }
