...
{
    public class SharpDisplayProtocolStyle02 : SharpDisplayBase, IHasPower, IHasPowerToggle, IHasInput
    {
        ...
        public SharpDisplayProtocolStyle02(SharpDisplayPluginDevice device, SharpDisplayPluginConfigObject config)
            : base(device, config)
        {
        ...
        {
            DisplayDevice.SendLine("PWR1   ");
        }

        public override void PowerOff()
        {
            DisplayDevice.SendLine("PWR0   ");
        }
